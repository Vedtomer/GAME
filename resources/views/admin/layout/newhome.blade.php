            ...
            <div  >
                ...
                <div class="sidebar">
                                ...
                                <div>
                                    <div>
                                        <div>
                                            <div style="background-image:url(desktop/currenttime_.png);background-repeat:no-repeat;background-position: center center; background-color: rgb(39, 146, 133); border-radius:30px; white-space: nowrap; overflow: hidden;    margin-bottom: 20px;">
                                    ...
                                    <div>
                                        <div style="background-image:url(desktop/date_.png);background-repeat:no-repeat; background-position: center center;  width: 232px; max-height: 48px; background-color:rgb(73, 208, 232); border-radius:30px; margin-bottom: 20px; overflow: hidden;">
                                            <?php
                ...
                <div style="display: flex; flex-direction: column; align-items: center; margin-bottom: 20px;">
                    <div style="background-image: url('{{ asset('logo12_files/ring.png') }}'); background-repeat: no-repeat; background-size: 150px 150px; background-position: center center; width: 150px; height: 380px;"></div>
                </div>
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <table class="caltable" cellpadding="0" cellspacing="0">
                                            ...
                                            <br>
                                            <img src="logo12_files/60small.png" style="height:100px;width:100px;margin-left:70PX">
                                            <br>
                                            ...
                                            <input type="text" style="width:100px; height:30px; border-color:Blue;margin-left:-50px;font-size:larger;font-weight:bold;" id="t_3" maxlength="6">
                                                <input type="button" class="divCells8" style="color:rgb(153, 0, 255);margin-left:10px;font-size:12px;font-weight:bold;background-color:rgb(43, 162, 226); border-radius: 30px" onclick="calc()" id="t_4" value="Click here for Predication">
                                            </td>
