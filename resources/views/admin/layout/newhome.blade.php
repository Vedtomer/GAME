...
<body>
    <div class="container">
        ...
        <div class="mains">
            ...
            <span id="spredic2" style="font-size:24px;display:none;color:Yellow;">
                    ...
                    <tr>
                        ...
                        <td
                            ...
                            <input type="button" class="divCells8"
                                ...
                                onclick="calc()" id="t_4" value="Click here for Predication">
                        </td>
    ...
    <div class="banner">
        <img style="max-width: 100%;height:400px;min-width: 54%" src="{{ asset('vid.gif') }}"> </img>
    </div>
